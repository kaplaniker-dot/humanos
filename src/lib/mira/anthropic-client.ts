...
// Day 12 fix — REPORT_MAX_TOKENS 4096 → 8192 (truncation bug, JSON parse fail)
...
export const MIRA_DEFAULTS = {
  ...
  // Maksimum token (rapor için)
  // Day 11: 4096 idi → Day 12 fix: 8192'ye çıkarıldı.
  // Sebep: 4096'da Mira ~9800 char (~4097 token) civarında JSON'u
  // tamamlayamadan kesiliyordu. 8192 ferah buffer sağlar.
  // Sonnet 4.6 max_tokens üst limiti: 64000.
